...
import { englishNumber, persianNumber } from "../../utils/function";
...
export const CheckoutPage = (props) => {
  ...
  return (
    <div className="contentWithHeaderAndFooter">
      <Helmet>
        <title>{`نهایی کردن سبد خرید`}</title>
        <meta
          name="description"
          content="%REACT_APP_WEBSITE_NAME% | نهایی کردن سبد خرید"
        />
      </Helmet>
      ...
      {basket.card.length > 0 ? (
        ...
        localStorage.getItem("IS_LOGGED_IN") == "true" ? (
              ...
              <div className={Styles.row}>
                ...
                <div className={Styles.col}>
                  ...
                  <Input
                    ...
                    id="input_phone"
                    type="text"
                    defaultValue={persianNumber(userInfo.phone)}
                    required
                  />
                </div>
              </div>
              <div className={Styles.row}>
                ...
                <div className={Styles.col}>
                  <Button
                    ...
                    size="large"
                    onClick={() =>
                      Nav(`${process.env.REACT_APP_BASE_URL}/payment`)
                    }
                    btnType="submit"
                  />
                </div>
          ...
          <div className={Styles.loginBox}>
            <h1>برای تکمیل خرید باید ابتدا وارد شوید</h1>
